...
[測試一](#測試一固定模型架構及參數下資料是否正規化之比較)：資料是否正規化之比較  
[測試二](#測試二固定模型架構及參數下資料是否進行shuffle之比較)：資料是否進行Shuffle之比較  
[測試三](#測試三固定參數下卷積層層數多寡之比較至少三種網路架構例如兩層三層四層)：卷積層層數多寡之比較  
[測試四](#測試四固定層數其他參數下調整filters大小之比較至少三種數值例如163264)：調整Filters大小之比較  
[測試五](#測試五固定層數其他參數下調整kernel_size大小之比較至少三種數值例如4-45-57-7)：調整Kernel Size大小之比較  
[測試六](#測試六固定層數其他參數下調整pool_size大小之比較至少三種數值例如2-23-34-4)：調整Pool Size大小之比較  
[測試七](#測試七固定參數下隱藏層層數多寡之比較至少三種網路架構例如兩層三層四層)：隱藏層層數多寡之比較  
[測試八](#測試八固定隱藏層層數及其他參數下-隱藏層大小之比較至少三種數量例如51212864)：調整隱藏層大小之比較  
[測試九](#測試九固定參數下dropout層數多寡之比較至少三種網路架構例如兩層三層四層)：Dropout層層數多寡之比較  
[測試十](#測試十固定dropout層數及其他參數下dropout比例之比較至少三種比例例如204060)：調整Dropout比例之比較  
[測試十一](#測試十一固定網路架構及參數下選用不同優化器之比較至少三種優化器例如sgdrmspropadam)：不同優化器之比較  
[測試十二](#測試十二固定網路架構及參數下不同epoch之比較至少三種數量例如102050)：不同Epoch數量之比較  
[結論](#結論)  
---
